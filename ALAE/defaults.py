...
# Custom flow-matching configuration
_C.CUSTOM_FLOW = CN()
_C.CUSTOM_FLOW.model = 'icnn2'
_C.CUSTOM_FLOW.args = CN()
_C.CUSTOM_FLOW.args.dim               = 128
_C.CUSTOM_FLOW.args.dim_t             = 1
_C.CUSTOM_FLOW.args.dimh              = 1024
_C.CUSTOM_FLOW.args.num_hidden_layers = 5
_C.CUSTOM_FLOW.args.act_fn            = 'ssp'
_C.CUSTOM_FLOW.args.batch_size        = 1024
